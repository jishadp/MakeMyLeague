...
// Public player registration for a league
Route::get('leagues/{league}/player-register', [LeaguePlayerController::class, 'showPublicRegistration'])->name('league-players.public-register');
Route::post('leagues/{league}/player-register', [LeaguePlayerController::class, 'storePublicRegistration'])->name('league-players.public-register.store');
...
Route::middleware('auth')->group(function () {
    ...
    Route::prefix('leagues/{league}')->name('leagues.')->middleware('league.organizer')->group(function () {
        ...
        Route::delete('fixtures/{fixture}', [\App\Http\Controllers\LeagueMatchController::class, 'deleteFixture'])->name('fixtures.delete');
    });
    ...
    Route::prefix('scorer')->name('scorer.')->group(function () {
        ...
        Route::get('matches/{fixture:slug}/edit', [\App\Http\Controllers\ScorerDashboardController::class, 'editMatch'])->name('matches.edit');
        Route::put('matches/{fixture:slug}', [\App\Http\Controllers\ScorerDashboardController::class, 'updateMatch'])->name('matches.update');
...
Route::get('{league}/players', [\App\Http\Controllers\LeagueController::class, 'publicPlayers'])
