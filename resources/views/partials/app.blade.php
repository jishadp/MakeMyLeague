...
<head>
    ...
    <!-- Theme CSS Files -->
    <link rel="stylesheet" id="theme-css" href="{{ asset('css/deep-teal-theme.css') }}?v={{ time() }}">

    @yield('styles')
</head>
<body class="bg-gray-50 antialiased min-h-screen flex flex-col deep-teal-theme" id="app-body">
