            ...
            <div class="control-card" style="grid-column: 1 / -1; background: linear-gradient(135deg, #f0f9ff, #e0f2fe);">
                <div class="flex items-center justify-between gap-4 flex-wrap">
                    ...
                    <a href="{{ route('auction.manage-players', $league) }}" 
                       class="px-4 py-2.5 rounded-xl bg-gradient-to-r from-indigo-600 to-violet-600 text-sm font-bold hover:from-indigo-700 hover:to-violet-700 flex items-center gap-2 transition-all shadow-lg shadow-indigo-500/25">
                        <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
