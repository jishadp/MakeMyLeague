...
<div class="lg:col-span-2">
    <div class="bg-white rounded-lg shadow-lg">
        ...
        <div class="p-4 sm:p-6">
            ...
            <div class="mb-6">
                <div class="flex flex-col sm:flex-row gap-4">
                    ...
                    <div class="flex gap-2">
                        <select id="roleFilter" class="px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent">
            ...
            <!-- Players Grid -->
            <div class="grid grid-cols-1 md:grid-cols-2 gap-4" id="playersList">
                @forelse($availablePlayers as $player)
                <div class="border border-gray-200 rounded-lg p-4 hover:border-blue-300 hover:shadow-md transition-all duration-200 player-card" 
                    ...
                    <div class="flex items-start justify-between mb-3">
                        <div class="flex items-center space-x-3">
                            <div class="w-12 h-12 rounded-full overflow-hidden bg-gradient-to-r from-blue-500 to-purple-600 flex items-center justify-center">
                    ...
                    <div class="grid grid-cols-2 gap-3 mb-4 text-sm">
                        <div class="flex items-center space-x-2">
                            ...
                            <span class="text-gray-600">{{ $player->user->mobile }}</span>
                        </div>
                        <div class="flex items-center space-x-2">
                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            <span class="text-gray-600">{{ $player->user->localBody->name ?? 'Unknown' }}</span>
                        </div>
                    </div>
