        ...
        <div class="p-4 sm:p-6">
            ...
            <div id="cardView" class="players-container">
                <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4" id="playersList">
                    ...
                    <div class="glass-card p-4 hover:shadow-lg transition-all duration-300 player-card group" 
                         ...
                         data-base-price="50000"
                         data-league-player-id="1"
                         data-player-role="Batsman"
                         data-player-mobile="+91 98765 43210">
                        ...
                        <div class="flex items-start justify-between mb-4">
                            <div class="flex items-center space-x-3">
                                ...
                                <div class="flex-1 min-w-0">
                                    <h3 class="font-semibold text-gray-900 text-lg truncate">Virat Kohli</h3>
                        ...
                        <div class="grid grid-cols-1 gap-3 mb-4 text-sm">
                            <div class="flex items-center space-x-2">
                                ...
                                <span class="text-gray-600 truncate">+91 98765 43210</span>
                            </div>
                            <div class="flex items-center space-x-2">
                                <svg class="w-4 h-4 text-gray-400 flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                ...
                                <span class="text-gray-600 truncate">Mumbai</span>
                            </div>
                        </div>

                        <!-- Action Buttons -->
                        <div class="flex space-x-2">
                            <button onclick="startBidding('1', 'Virat Kohli', '50000', 'Batsman')"
            ...
            <div id="listView" class="players-container hidden">
                <div class="space-y-3" id="playersListList">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between mb-2">
                                    <h3 class="font-semibold text-gray-900 text-lg truncate">Virat Kohli</h3>
                                    <div class="text-right">
                                        <div class="text-xl font-bold text-green-600">₹50,000</div>
                                        <div class="text-xs text-gray-500">Base Price</div>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                    <div class="flex items-center space-x-4 text-sm text-gray-600">
                                        ...
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <span class="truncate">+91 98765 43210</span>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                    ...
                    <div class="glass-card p-4 hover:shadow-lg transition-all duration-300 player-card group" 
                         data-player-id="2"
                         data-player-name="Rohit Sharma"
                         data-base-price="45000"
                         data-league-player-id="2"
                         data-player-role="Batsman"
                         data-player-mobile="+91 98765 43211">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <div class="flex-1 min-w-0">
                                <div class="flex items-center justify-between mb-2">
                                    <h3 class="font-semibold text-gray-900 text-lg truncate">Rohit Sharma</h3>
                                    <div class="text-right">
                                        <div class="text-xl font-bold text-green-600">₹45,000</div>
                                        <div class="text-xs text-gray-500">Base Price</div>
                                    </div>
                                </div>
                                ...
                                <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-2">
                                    <div class="flex items-center space-x-4 text-sm text-gray-600">
                                        ...
                                        <div class="flex items-center space-x-1">
                                            ...
                                            <span class="truncate">+91 98765 43211</span>
                                        </div>
                                        <div class="flex items-center space-x-1">
                                            <svg class="w-4 h-4 text-gray-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M17.657 16.657L13.414 20.9a1.998 1.998 0 01-2.827 0l-4.244-4.243a8 8 0 1111.314 0z"></path>
                                    ...
                                    <!-- Action Buttons -->
                                    <div class="flex space-x-2">
                                        <button onclick="startBidding('2', 'Rohit Sharma', '45000', 'Batsman')"
                                                class="bg-green-600 hover:bg-green-700 text-white px-4 py-2 rounded-lg text-sm font-medium transition-colors duration-200 flex items-center space-x-2 group-hover:shadow-md">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                                            </svg>
                                        ...
                                        <button onclick="viewPlayerDetails('2')"
                                                class="bg-gray-100 hover:bg-gray-200 text-gray-700 px-3 py-2 rounded-lg text-sm transition-colors duration-200">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
