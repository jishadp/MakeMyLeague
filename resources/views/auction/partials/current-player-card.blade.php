                                ...
                                <div class="sm:col-span-4 flex justify-center">
                                    <div class="relative">
                                        ...
                                        @if($currentPlayer->retention)
                                            <div class="absolute -bottom-3 -right-3 w-9 h-9 bg-yellow-400 rounded-full flex items-center justify-center shadow-lg" title="Retained player" aria-hidden="true">
