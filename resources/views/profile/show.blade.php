...
<div class="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 py-6">
    <div class="max-w-md mx-auto px-4">
        ...
        <form action="{{ route('profile.update') }}" method="POST">
            ...
            <button type="submit" 
                    class="w-full bg-gradient-to-r from-blue-500 to-indigo-600 text-white py-3 px-4 rounded-lg font-medium hover:from-blue-600 hover:to-indigo-700 transition-all duration-200 shadow-lg hover:shadow-xl mb-6">
                Update Profile
            </button>
        </form>
