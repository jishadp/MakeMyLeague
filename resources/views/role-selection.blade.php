...
<head>
    ...
    <title>Select Your Role - League Manager</title>
        ...
        <div class="max-w-2xl w-full space-y-8">
            ...
            <div class="glass-card p-8">
                ...
                <form method="POST" action="{{ route('role-selection.store') }}" class="space-y-6">
                    ...
                    <!-- Role Selection -->
                    <div class="space-y-4">
                        <label class="block text-sm font-medium text-gray-700 mb-4">Select Your Role <span class="text-red-600">*</span></label>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                            ...
                            <div class="relative">
                                ...
                                <label for="role_{{ $role->id }}" 
                                    ...
                                    <!-- Role Name -->
                                    <span class="text-sm font-medium text-center capitalize">{{ $role->name }}</span>
