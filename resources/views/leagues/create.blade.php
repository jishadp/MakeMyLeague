...
<div class="max-w-6xl mx-auto py-6 sm:py-12 px-4 sm:px-6 lg:px-10">
    <h1 class="text-2xl sm:text-3xl font-bold mb-6 sm:mb-10 text-gray-800">🏆 Create New League</h1>
        ...
        <div class="bg-white shadow-md rounded-2xl p-4 sm:p-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
                <div>
                    ...
                    <input type="text" name="name" id="name" value="{{ old('name') }}" required minlength="3"
                ...
                <div>
                    <label for="season" class="block text-sm font-medium text-gray-700 mb-1">Season Number (1-100) *</label>
                    <input type="number" id="season" name="season" value="{{ old('season', 1) }}" min="1" max="100" required
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="start_date" id="start_date" value="{{ old('start_date') }}" required readonly
                ...
                <div>
                    ...
                    <div class="relative">
                        <input type="text" name="end_date" id="end_date" value="{{ old('end_date') }}" required readonly
        ...
        <div class="bg-white shadow-md rounded-2xl p-4 sm:p-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8 mb-6">
                ...
                <div>
                    ...
                    <input type="text" name="venue_details" id="venue_details" value="{{ old('venue_details') }}"
        ...
        <div class="bg-white shadow-md rounded-2xl p-4 sm:p-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
                <div>
                    <label for="max_teams" class="block text-sm font-medium text-gray-700 mb-1">Maximum Teams *</label>
                    <input type="number" id="max_teams" name="max_teams" 
                        value="{{ old('max_teams', 8) }}" min="2" required
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
                    @error('max_teams') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label for="max_team_players" class="block text-sm font-medium text-gray-700 mb-1">Players per Team *</label>
                    <input type="number" id="max_team_players" name="max_team_players" 
                        value="{{ old('max_team_players', 15) }}" min="1" required
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
                    @error('max_team_players') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-md rounded-2xl p-4 sm:p-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
                <div>
                    <label for="team_reg_fee" class="block text-sm font-medium text-gray-700 mb-1">Team Reg Fee (₹) *</label>
                    <input type="number" name="team_reg_fee" id="team_reg_fee" value="{{ old('team_reg_fee', 0) }}" min="0" step="0.01" required
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
                    @error('team_reg_fee') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label for="player_reg_fee" class="block text-sm font-medium text-gray-700 mb-1">Player Reg Fee (₹) *</label>
                    <input type="number" name="player_reg_fee" id="player_reg_fee" value="{{ old('player_reg_fee', 0) }}" min="0" step="0.01" required
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
                    @error('player_reg_fee') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label for="team_wallet_limit" class="block text-sm font-medium text-gray-700 mb-1">Team Wallet Limit (₹) *</label>
                    <input type="number" name="team_wallet_limit" id="team_wallet_limit" value="{{ old('team_wallet_limit', 0) }}" min="0" step="0.01" required
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
                    @error('team_wallet_limit') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
            </div>
        </div>
        ...
        <div class="bg-white shadow-md rounded-2xl p-4 sm:p-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-4 sm:gap-8">
                <div>
                    ...
                    @error('retention') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
                <div>
                    <label for="retention_players" class="block text-sm font-medium text-gray-700 mb-1">Max Retention Players</label>
                    <input type="number" id="retention_players" name="retention_players" 
                        value="{{ old('retention_players', 0) }}" min="0"
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
                    @error('retention_players') <p class="text-red-500 text-xs mt-1">{{ $message }}</p> @enderror
                </div>
            </div>
        </div>
