        ...
        <div class="bg-white shadow-md rounded-2xl p-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <select id="game_id" name="game_id" required
                        ...
                        @foreach($games as $game)
                            <option value="{{ $game->id }}" {{ old('game_id', $league->game_id) == $game->id ? 'selected' : '' }}>
                                {{ $game->name }}
                            </option>
                        @endforeach
                    </select>
                ...
                <div>
                    ...
                    <input type="number" id="season" name="season" value="{{ old('season', $league->season) }}" min="1" max="100" required
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
        ...
        <div class="bg-white shadow-md rounded-2xl p-8 border border-gray-100">
            ...
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div>
                    ...
                    <input type="number" name="team_reg_fee" id="team_reg_fee" value="{{ old('team_reg_fee', $league->team_reg_fee) }}" min="0" step="0.01" required
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
                ...
                <div>
                    ...
                    <input type="number" name="player_reg_fee" id="player_reg_fee" value="{{ old('player_reg_fee', $league->player_reg_fee) }}" min="0" step="0.01" required
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
                ...
                <div>
                    ...
                    <input type="number" name="team_wallet_limit" id="team_wallet_limit" value="{{ old('team_wallet_limit', $league->team_wallet_limit) }}" min="0" step="0.01" required
                        class="w-full rounded-lg border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 shadow-sm py-3 px-4">
