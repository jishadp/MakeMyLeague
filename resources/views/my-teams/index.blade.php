                ...
                <div class="bg-white rounded-2xl shadow-lg overflow-hidden hover:shadow-2xl hover:scale-[1.02] transition-all duration-300 animate-fadeInUp">
                    ...
                    <div class="p-6">
                        ...
                        <div class="mt-4 flex justify-center">
                            <button onclick="toggleActionButtons('{{ $team->id }}')" 
                                ...
                                <svg id="toggleIcon-{{ $team->id }}" class="w-4 h-4 transition-transform duration-200" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M19 9l-7 7-7-7"></path>
                                </svg>
                                <span id="toggleText-{{ $team->id }}">Show Actions</span>
                            </button>
                        </div>
                        
                        <!-- Action Buttons -->
                        <div id="actionButtons-{{ $team->id }}" class="grid grid-cols-3 gap-3 mt-4 hidden">
...
function toggleActionButtons(teamId) {
    const actionButtons = document.getElementById(`actionButtons-${teamId}`);
    const toggleIcon = document.getElementById(`toggleIcon-${teamId}`);
    const toggleText = document.getElementById(`toggleText-${teamId}`);
