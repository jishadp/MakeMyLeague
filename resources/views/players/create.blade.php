                ...
                <form action="{{ route('players.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="flex items-center space-x-4">
                            ...
                            <button type="button" id="selectPhotoBtn" class="px-4 py-2 bg-indigo-600 rounded-lg hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-indigo-500">
