                ...
                <div class="p-8">
                    ...
                    <form action="{{ route('players.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <!-- Mobile -->
                            <div>
                                <label for="mobile" class="block text-sm font-medium text-gray-700 mb-2">Mobile Number
                            ...
                            <!-- PIN -->
                            <div>
                                <label for="pin" class="block text-sm font-medium text-gray-700 mb-2">PIN (4 digits)
                                    <span class="text-red-500">*</span></label>
                            ...
                            <!-- Player Role -->
                            <div>
                                <label for="position_id" class="block text-sm font-medium text-gray-700 mb-2">Player
                            ...
                            <div>
                                <label for="local_body_id" class="block text-sm font-medium text-gray-700 mb-2">Local Body 
                                     <span class="text-red-500">*</span></label>
                                <select name="local_body_id" id="local_body_id" required
                                    ...
                                    @foreach ($localBodies as $localBody)
                                        <option value="{{ $localBody->id }}"
                                            {{ old('local_body_id') == $localBody->id ? 'selected' : '' }}>
                                            {{ $localBody->name }}
                                        </option>
                                    @endforeach
                                </select>
                        ...
                        <!-- Profile Photo -->
                        <div class="mt-6">
                            <label for="photo" class="block text-sm font-medium text-gray-700 mb-2">Profile Photo
                                (Optional)</label>
