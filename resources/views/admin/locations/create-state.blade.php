...
@section('title', 'Admin - Create State - ' . config('app.name'))
    ...
    <div class="max-w-7xl mx-auto">
        <div class="text-center">
            ...
            <p class="text-lg sm:text-xl text-white/90">
                Add a new state to the location hierarchy
            </p>
        </div>
    </div>
</section>
...
<section class="py-12 px-4 sm:px-6 lg:px-8 bg-gray-50">
    <div class="max-w-2xl mx-auto">
        ...
        <div class="bg-white rounded-2xl shadow-lg p-8 animate-fadeInUp">
            <form action="{{ route('admin.locations.store-state') }}" method="POST" class="space-y-6">
                @csrf
                ...
                <div>
                    ...
                    <input type="text" 
                           ...
                           name="name" 
                           value="{{ old('name') }}"
                           class="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-blue-500 focus:border-blue-500 transition-colors @error('name') border-red-500 @enderror"
                ...
                <div class="flex flex-col sm:flex-row gap-4 pt-6">
                    <button type="submit" 
                            class="flex-1 bg-blue-600 hover:bg-blue-700 text-black px-6 py-3 rounded-xl font-semibold transition-colors shadow-lg hover:shadow-xl">
