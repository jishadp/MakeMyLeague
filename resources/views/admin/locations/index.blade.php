        ...
        <div class="bg-white rounded-2xl shadow-lg p-6 mb-8 animate-fadeInUp">
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                ...
                <a href="{{ route('admin.leagues.index') }}" 
                   class="flex items-center p-4 bg-pink-50 border border-pink-200 rounded-xl hover:bg-pink-100 transition-colors {{ request()->routeIs('admin.leagues.*') ? 'ring-2 ring-pink-500' : '' }}">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-pink-700">Manage & edit all leagues</p>
                    </div>
                </a>
            </div>
        </div>
