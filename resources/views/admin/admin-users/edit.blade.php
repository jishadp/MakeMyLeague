        ...
        <div class="bg-white rounded-lg shadow-sm p-6 mb-8">
            <div class="flex flex-col sm:flex-row justify-between items-start gap-4">
                <div>
                    ...
                    <p class="text-gray-600 mt-2">Update admin user information</p>
                </div>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <input type="tel" 
                               name="mobile" 
                               id="mobile" 
                               value="{{ old('mobile', $adminUser->mobile) }}"
                    ...
                    <div>
                        ...
                        <input type="password" 
                               ...
                               minlength="4"
                               maxlength="6">
                        <p class="mt-1 text-sm text-gray-500">Leave blank to keep current PIN. PIN should be 4-6 digits long</p>
                        @error('pin')
                            <p class="mt-1 text-sm text-red-600">{{ $message }}</p>
                        @enderror
                    </div>
                            ...
                            <div class="ml-3">
                                ...
                                <div class="mt-2 text-sm text-blue-700">
                                    <ul class="list-disc list-inside space-y-1">
                                        ...
                                        <li>If you change the PIN, inform the admin user securely</li>
                                        <li>Mobile number is used for login authentication</li>
